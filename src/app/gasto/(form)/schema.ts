...
export const formSchema = z.object({
  ...
  montoAbonado: z.coerce.number<number>().min(1, 'Introduzca un monto válido').optional(),
  montoTotal: z.coerce.number<number>().min(1, 'Introduzca un monto válido').optional(),
  cuotasAbonadas: z.coerce.number<number>().min(1, 'Introduzca un número válido').optional(),
  totalCuotas: z.coerce.number<number>().min(1, 'Introduzca un número válido').optional()
});
